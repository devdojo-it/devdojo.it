...
class YoutubeEmbed extends HTMLElement {
  connectedCallback() {
    ...
    let playBtnEl = this.querySelector(".btn-play");
     ...
     *
     * See https://github.com/paulirish/youtube-embed-embed/blob/master/youtube-thumbnail-urls.md
     */
    ...
    if (!playBtnEl) {
      ...
      // Include the mispelled 'lty-' in case it's still being used. https://github.com/paulirish/youtube-embed-embed/issues/65
      playBtnEl.classList.add("btn-play");
    ...
    this.addEventListener("focusin", YoutubeEmbed.warmConnections, { once: true });
  ...
  // Add the iframe within <noscript> for indexability discoverability. See https://github.com/paulirish/youtube-embed-embed/issues/105
  addNoscriptIframe() {
   ...
   *
   * See https://github.com/paulirish/youtube-embed-embed/blob/master/youtube-thumbnail-urls.md for more details
   */
  upgradePosterImage() {
